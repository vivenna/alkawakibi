...
Farbschema in Türkis/Gelb). Statt eines Kompromisses liegen fünf vollständig
...
| `frontend/entwurf-4-tuerkis-gelb` | **Türkis & Gelb** | Handschrift von Entwurf 1 im gewünschten Farbschema: gedecktes Türkis mit kräftigem Gelb, türkise und helle Abschnitte im Wechsel, Merkmalstreifen unter dem Aufmacher. |
| `frontend/entwurf-5-smaragd` | **Smaragd** | Anlage wie Entwurf 1, aber ganz in den Logofarben: Grünverläufe von tief bis mint, weichere Formen. |
...
frontend/     die fünf fertigen Websites
```

### Warum ein Generator?

Die Entwürfe tragen dieselben Texte. Stünden sie fünffach in 65 HTML-Dateien,
müsste jede Korrektur – eine Telefonnummer, ein Satzungsparagraf, ein
Navigationspunkt – bis zu 65-mal nachgezogen werden. Deshalb liegen Inhalt und
...
werkzeuge/entwurf4.py        Gestaltung Türkis & Gelb
werkzeuge/entwurf5.py        Gestaltung Smaragd
...
(*Einstellungen → Pages*). Solange die Auswahl offen ist, liegen alle fünf
