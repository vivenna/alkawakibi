...
`frontend/entwurf-5-smaragd` als Veröffentlichungsquelle eintragen.

Zum Ansehen genügt lokal:

```
python3 -m http.server -d frontend/entwurf-5-smaragd 8000
```
...
die Gestaltung dieses Entwurfs in `werkzeuge/entwurf5.py`.
